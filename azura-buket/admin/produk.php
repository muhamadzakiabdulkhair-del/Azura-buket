...
<div class="container mt-5">
    ...
    <a href="tambah_produk.php" class="btn mb-3" style="background:#c0395e;color:#fff">+ Tambah Produk</a>
    ...
    <table class="table table-bordered table-striped" id="tabelProduk">
        ...
        <?php $no=1; while($row = mysqli_fetch_assoc($data)) { ?>
            <tr>
                ...
                <td>
                    <?php if($row['gambar'] != ''): ?>
                        <img src="gambar/<?= $row['gambar'] ?>" width="80" style="border-radius:6px;">
                    <?php else: ?>
                ...
                <td>
                    ...
                    <a href="hapus_produk.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus produk ini? Data tidak bisa dikembalikan!')">Hapus</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
