...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Staf — Azura Buket</title>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, #c0395e, #e8729a);">
    <div class="container-fluid">
        <a class="navbar-brand" href="#" style="font-family:Georgia,serif;font-weight:700;">🌸 Azura Buket — Staf</a>
...
<div class="container-fluid">
    <div class="row">
        ...
        <!-- SIDEBAR — sama persis dengan kedaikopi staf -->
        <div class="col-md-2 sidebar p-0">

            <div class="text-center py-3 border-bottom" style="border-color:rgba(255,255,255,.1)!important">
                <div style="width:44px;height:44px;background:linear-gradient(135deg,#c0395e,#e8729a);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:1.1rem;margin:0 auto 5px;">
            ...
            <a href="index.php?menu=transaksimasuk">📦 Barang Masuk</a>
            <a href="index.php?menu=riwayat_transaksimasuk">📋 Riwayat Masuk</a>
            ...
            <div style="padding:16px;border-top:1px solid rgba(255,255,255,.08);margin-top:8px">
